...
const propiedades = [
  {
    ...
    precio: 120000,
    operacion: 'Venta',
    caracteristicas: ['Aire acondicionado', 'Recepción', 'Sala de reuniones'],
    imagenes: ['/img/venta/oficina.png', '/img/destacadas/oficina.jpeg'],
  ...
  },
  {
    ...
    precio: 950,
    operacion: 'Alquiler',
    caracteristicas: ['Wifi', 'Cochera', 'Seguridad 24hs', 'Cocina'],
    imagenes: ['/img/alquiler/oficina.png', '/img/alquiler/oficina_grande.png'],
